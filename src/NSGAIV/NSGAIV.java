 ...
 * </ol>
 */
public class NSGAIV extends AbstractEvolutionaryAlgorithm implements
	...
	public void iterate() {
		...
		System.out.println("-----------------finish truncate--------------------------------");
	}
	...
	@Override
	public NSGAIVNondominatedSortingPopulation getPopulation() {
		return (NSGAIVNondominatedSortingPopulation)super.getPopulation();
	}
