 ...
 */
public class NSGAIVNondominatedSortingPopulation extends Population {
	 ...
	 */
	public NSGAIVNondominatedSortingPopulation() {
	 ...
	 */
	public NSGAIVNondominatedSortingPopulation(DominanceComparator comparator) {
		super();
		modified = false;
	 ...
	 * @param iterable the solutions used to initialize this population
	 */
	public NSGAIVNondominatedSortingPopulation(Iterable<? extends Solution> iterable) {
