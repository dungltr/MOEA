 ...
 */
public class NSGAVINondominatedSortingPopulation extends Population {
	 ...
	 */
	public NSGAVINondominatedSortingPopulation(DominanceComparator comparator) {
		super();
		modified = false; //old is false
		
		if (Settings.useFastNondominatedSorting()) {
			nondominatedSorting = new NSGAVIFastNondominatedSorting(comparator);
			//System.out.println("Using FastNondominatedSorting");
		} else {
			nondominatedSorting = new NSGAVINondominatedSorting(comparator);
	 ...
	 * @param iterable the solutions used to initialize this population
	 */
	public NSGAVINondominatedSortingPopulation(Iterable<? extends Solution> iterable) {
