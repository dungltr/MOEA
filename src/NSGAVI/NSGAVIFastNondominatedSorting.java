 ...
 * </ol>
 */
public class NSGAVIFastNondominatedSorting extends NSGAVINondominatedSorting {

	/**
	 * Constructs a fast non-dominated sorting operator using Pareto dominance.
	 */
	public NSGAVIFastNondominatedSorting() {
		super();
	}
	 ...
	 */
	public NSGAVIFastNondominatedSorting(DominanceComparator comparator) {
		super(comparator);
	}
