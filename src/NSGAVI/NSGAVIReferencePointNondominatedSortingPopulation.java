 ...
 * </ol>
 */
public class NSGAVIReferencePointNondominatedSortingPopulation extends NSGAVINondominatedSortingPopulation {
	 ...
	 */
	public NSGAVIReferencePointNondominatedSortingPopulation(int numberOfObjectives) {
		super();
	 ...
	 */
	public NSGAVIReferencePointNondominatedSortingPopulation(
	...
	private void initialize() {
		...
		//System.out.println("Say hello from initialize() in NSGAVI");
		//
	...
	protected Solution findSolutionWithMinimumDistance(List<Solution> solutions, double[] weight) {
		//System.out.println("Say hello from findSolutionWithMinimumDistance in NSGAVI Reference point");
		double minDistance = Double.POSITIVE_INFINITY;
