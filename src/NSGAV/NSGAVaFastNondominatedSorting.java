 ...
 * </ol>
 */
public class NSGAVaFastNondominatedSorting extends NSGAVaNondominatedSorting {

	/**
	 * Constructs a fast non-dominated sorting operator using Pareto dominance.
	 */
	public NSGAVaFastNondominatedSorting() {
		super();
	}
	 ...
	 */
	public NSGAVaFastNondominatedSorting(DominanceComparator comparator) {
		super(comparator);
	}
	...
	public void evaluate(Population population) {
		...
		//System.out.println("hello from FastNondominatedSorting.java in NSGAVa");
