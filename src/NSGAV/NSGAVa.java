 ...
 * </ol>
 */
public class NSGAVa extends AbstractEvolutionaryAlgorithm implements
	 ...
	 */
	public NSGAVa(Problem problem, NSGAVaNondominatedSortingPopulation population,
	...
	@Override
	public void iterate() {
		//System.out.println("----------iterate from NSGAVa.java------------------------------------------");
		NSGAVaNondominatedSortingPopulation population = getPopulation();
	...
	@Override
	public NSGAVaNondominatedSortingPopulation getPopulation() {
		return (NSGAVaNondominatedSortingPopulation)super.getPopulation();
	}
