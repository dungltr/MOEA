 ...
 */
public class NSGAVaNondominatedSortingPopulation extends Population {
	 ...
	 */
	public NSGAVaNondominatedSortingPopulation(DominanceComparator comparator) {
		super();
		modified = false; //old is false

		if (Settings.useFastNondominatedSorting()) {
			nondominatedSorting = new NSGAVaFastNondominatedSorting(comparator);
			//System.out.println("Using FastNondominatedSorting");
		} else {
			nondominatedSorting = new NSGAVaNondominatedSorting(comparator);
	 ...
	 * @param iterable the solutions used to initialize this population
	 */
	public NSGAVaNondominatedSortingPopulation(Iterable<? extends Solution> iterable) {
