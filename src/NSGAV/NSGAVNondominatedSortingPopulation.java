 ...
 */
public class NSGAVNondominatedSortingPopulation extends Population {
	 ...
	 */
	public NSGAVNondominatedSortingPopulation() {
	...
	public NSGAVNondominatedSortingPopulation(DominanceComparator comparator) {
		...
		if (Settings.useFastNondominatedSorting()) {
			...
			//System.out.println("Using NSGAVFastNondominatedSorting");
		} else {
			nondominatedSorting = new NSGAVNondominatedSorting(comparator);
			//System.out.println("Using Original NSGAVNondominatedSorting");
		}
	}
	 ...
	 * @param iterable the solutions used to initialize this population
	 */
	public NSGAVNondominatedSortingPopulation(Iterable<? extends Solution> iterable) {
