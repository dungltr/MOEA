 ...
 * </ol>
 */
public class NSGAV extends AbstractEvolutionaryAlgorithm implements
	...
	@Override
	public NSGAVNondominatedSortingPopulation getPopulation() {
        //System.out.println("NSGAVNondominatedSortingPopulation getPopulation() from NSGAV.java");
		return (NSGAVNondominatedSortingPopulation)super.getPopulation();
	}
