...
public class Example2 {
	...
	private static int MaxEvaluations = 100000;
	private static int numberSeeds = 25;
	...
	public static void main(String[] args) throws IOException {
		...
		String Caption = "";
		String homeFile =ReadFile.readhome("HOME_jMetalData")+"/"+"MOEA_DTLZ"+Min+"_"+Max+"O_InGroup"+populationSize+"P"+MaxEvaluations+"M"+numberSeeds+"N";
		//NSGAVa : remove in Grid
		//NSGAV : remove in Group
		//String texFile = File + ".tex";
		//String[] problems = {"UF1","UF2","UF3","DTLZ1.8D","DTLZ2.8D","DTLZ3.8D"};
		String [] allAlgorithms = { "NSGAV","NSGAIII", "NSGAII", "eNSGAII", "GDE3", "MOEAD"};
		...
		String[] UF = {"UF1","UF3"};//"UF2","UF4","UF5","UF6"};
		String[] ZDT = {"ZDT1","ZDT3"};//"ZDT2","ZDT4","ZDT5","ZDT6"};
		String[] DTLZ_2 = {"DTLZ1_2","DTLZ3_2"};//,"DTLZ2_2","DTLZ4_2"};//
		String[] DTLZ_3 = {"DTLZ1_3","DTLZ3_3"};//,"DTLZ3_3","DTLZ4_3"};
		String[] DTLZ_4 = {"DTLZ1_4","DTLZ3_4"};//,"DTLZ3_4","DTLZ4_4"};
		String[] DTLZ_6 = {"DTLZ1_6","DTLZ3_6"};//,"DTLZ3_6","DTLZ4_6"};
		String[] DTLZ_8 = {"DTLZ1_8","DTLZ3_8"};//,"DTLZ3_8","DTLZ4_8"};
		//String[] DTLZ = DTLZ_8;
		...
		*/
		...
		for (int i=0; i<Standards.size(); i++){
			...
			DTLZ3Distance(homeFile, problemsDTLZ3, algorithms, Caption, end);
...
public static void DTLZ4Distance(String homeFile, List<DTLZ4> Problems, String[] algorithms, String Caption, boolean end)throws IOException{
	...
	public static void testStandardDistance(String File, DTLZ1 problem, String[] algorithms, String Caption) throws IOException{		
		...
		for (String algorithm : algorithms) {
			analyzer.addAll(algorithm, 
					executor.withAlgorithm(algorithm).withProblem(problem.getName().toString()+"_"+problem.getNumberOfObjectives()).runSeeds(File,numberSeeds));
		}
		//print the results
	...
	public static void testStandardDistance(String File, String problem, String[] algorithms, String Caption) throws IOException{		
		...
		for (String algorithm : algorithms) {
			analyzer.addAll(algorithm, 
					executor.withAlgorithm(algorithm).runSeeds(File,numberSeeds));
		}
		//print the results
		//analyzer.showAggregate();
		analyzer.printAnalysis();
